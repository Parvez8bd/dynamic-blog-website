    ...
    <div class="container">
        <div class="wrapper fadeInDown">
            ...
            <form method="POST" action="{{ route('register') }}" class="form">
                ...
                <input type="text" id="name" class="fadeIn second" name="name" value="{{old('name')}}" placeholder="Name" required>
                ...
                <input type="text" id="email" class="fadeIn second" name="password_confirmation"
            ...
            <!-- Remind Passowrd -->
            <div id="formFooter">
                <a class="underlineHover" href="{{ route('login') }}">Already registered ?</a><br>
